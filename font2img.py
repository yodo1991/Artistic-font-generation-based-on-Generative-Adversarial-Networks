...
parser.add_argument('--ttf_path', type=str, default='./ttf_folder2',help='ttf directory')
parser.add_argument('--chara', type=str, default='./character.txt',help='characters')
parser.add_argument('--save_path', type=str, default='./save_folder2',help='images directory')
parser.add_argument('--img_size', type=int, default=80, help='The size of generated images')
parser.add_argument('--chara_size', type=int, default=55, help='The size of generated characters')
